      ...
      <div className="w-full max-w-md">
        <div className="bg-black/80 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border border-cyan-500/20 shadow-2xl">
          <div className="text-center mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl font-black trippy-text mb-2">Sign Up</h1>
            <p className="text-sm sm:text-base text-gray-400">Join the TrippyDrip community</p>
          </div>
