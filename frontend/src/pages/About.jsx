...
const About = () => {
  return (
    <div className="min-h-screen pt-28 relative z-[1]">
      ...
      <MarqueeStrip
        messages={['CREATIVITY', 'ENERGY', 'PASSION', 'COMMUNITY', 'SELF-EXPRESSION', 'BOLD DESIGNS', 'COSMIC VIBES']}
        className="text-white/30 border-y border-zinc-800/50 py-2"
        speed={45}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-20">
          ...
          <ScrollReveal direction="right">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-gradient-to-br from-cyan-500 to-magenta-500 rounded-3xl blur-3xl opacity-20"></div>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-20">
          {[
            { icon: Sparkles, color: 'cyan', title: 'Creativity', desc: 'Pushing boundaries with every design' },
            { icon: Zap, color: 'magenta', title: 'Energy', desc: 'Infusing vibes into every piece' },
            { icon: Heart, color: 'yellow', title: 'Passion', desc: 'Love for art and self-expression' },
            { icon: Users, color: 'green', title: 'Community', desc: 'Building a tribe of vibers' },
          ].map((val, i) => (
            <ScrollReveal key={val.title} delay={i * 100}>
              <div className="glow-card text-center p-8 rounded-2xl bg-zinc-900/50 backdrop-blur-sm border border-zinc-800">
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-${val.color}-500/10 flex items-center justify-center`}>
        ...
        {/* CTA */}
        <ScrollReveal>
          <div className="text-center py-16 px-6 rounded-3xl bg-gradient-to-r from-zinc-900 to-zinc-800 border border-zinc-700 relative overflow-hidden shimmer">
            <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-cyan-500 via-magenta-500 to-yellow-400"></div>
